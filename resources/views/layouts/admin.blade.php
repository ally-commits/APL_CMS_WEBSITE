    ...
    <head>
        ...
        <title>APL - ADMIN DASHBOARD</title> 
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ asset('img/admin.jpg') }}" alt="Header Avatar">
                                    ...
                                    <div class="simplebar-content" style="padding: 0px;">
                                        <div id="sidebar-menu" class="mm-active"> 
                                            <ul class="metismenu list-unstyled mm-show" id="side-menu">
                                                ...
                                                <li>
                                                    <a href="/admin/fixtures" class="waves-effect">
                                                        <div class="d-inline-block icons-sm mr-1"><i class="mdi mdi-map"></i></div>
                                                        <span>Generate Fixture</span>
                                                    </a>
                                                </li>  
                                                <li>
                                                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                                                        <div class="d-inline-block icons-sm mr-1"><i class="mdi mdi-account-box-multiple-outline"></i></div>
                                                        <span>Manage Owner</span>
                                                    </a>
                                                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                                                        <li><a href="/admin/owner/create">Add Owner</a></li> 
                                                        <li><a href="/admin/owner">View Owners</a></li> 
                                                    </ul>
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sub-menu mm-collapse" aria-expanded="false"> 
                                                        <li><a href="/admin/player">View Players</a></li> 
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div> 
